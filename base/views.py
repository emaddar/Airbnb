...
def result(request):
    ...
    if (request.user.last_name == "France" and city in ["Paris", "Lyon","Bordeaux","Pays_Basque"]) or (request.user.last_name == "Belgium" and city in ["Antwerp", "Brussels","Ghent"]) or (request.user.last_name == "Netherlands" and city in ["Amsterdam", "Rotterdam","The_Hague"]) or (request.user.last_name == "United Kingdom" and city in ["London", "Bristol","Greater_Manchester", "Edinburgh"]):
        ...
        return render(request, 'result.html', {
                                                'city':city,
                                                'q1': q1.reset_index().to_html(classes="table table-compact w-64 mx-auto",justify="left"),
                                                'nc' : nc,
                                                'hc' : hc, 
                                                ...
                                                'amenities' : amenities.reset_index().to_html(classes="table table-compact w-64 mx-auto",justify="left"),
                                                'q5' : q5.reset_index().to_html(classes="table table-compact w-64 mx-auto",justify="left"),
                                                'q6' : q6.reset_index().to_html(classes="table table-compact w-64 mx-auto",justify="left"),
                                                'q7' : round(q7,2),
                                                'q8' : round(q8,2),
